...
function component($productname,$productprice,$productimg,$productid){
    ...
    <form action="index.php" method="post">
        <div class="card shadow itemCustom">
            <div>
                <img src="%s" alt="img1" class="img-fluid card-img-top" style="height:200px"> 
            </div>
            <div class="card-body">
...
';
echo sprintf($element,$productimg,$productname,$productprice,$productid);
}
